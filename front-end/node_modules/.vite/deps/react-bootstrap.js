...
import {
  require_prop_types
} from "./chunk-QZZPPBNK.js";
import "./chunk-KUHJD3OE.js";
import {
  Button_default,
  Button_default2,
  useButtonProps
} from "./chunk-MK6BCEXK.js";
import {
  DEFAULT_BREAKPOINTS,
  ...
  useBootstrapPrefix,
  useIsRTL
} from "./chunk-436PTE2A.js";
import {
  require_classnames
} from "./chunk-XJWELA6E.js";
import {
  require_jsx_runtime
...
var FormCheck = React45.forwardRef(({
  ...
  return (0, import_jsx_runtime39.jsx)(FormContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime39.jsx)("div", {
      style,
      className: (0, import_classnames27.default)(className, hasLabel && bsPrefix, inline && `${bsPrefix}-inline`, type === "switch" && bsSwitchPrefix),
...
var Offcanvas = React71.forwardRef(({
  ...
  const renderBackdrop = (0, import_react48.useCallback)((backdropProps) => (0, import_jsx_runtime67.jsx)("div", {
    ...backdropProps,
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime67.jsx)("div", {
    ...
    ...dialogProps,
    ...props,
    className: (0, import_classnames47.default)(className, bsPrefix, `${bsPrefix}-${placement}`),
    "aria-labelledby": ariaLabelledby,
    children
  });
...
function useOverlayOffset(customOffset) {
  ...
  const offset = (0, import_react53.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime77.jsxs)(import_jsx_runtime76.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react55.cloneElement)(children, triggerProps), (0, import_jsx_runtime75.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
function createButton(name, defaultValue, label = name) {
  function Button({
    ...
    return (0, import_jsx_runtime79.jsxs)(PageItem, {
      ...props,
...
var Table = React95.forwardRef(({
  ...
  const classes = (0, import_classnames61.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size && `${decoratedBsPrefix}-${size}`, striped && `${decoratedBsPrefix}-striped`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
...
var ToastFade = React97.forwardRef((props, ref) => (0, import_jsx_runtime99.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContainer = React101.forwardRef(({
  ...
  return (0, import_jsx_runtime103.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames64.default)(bsPrefix, position && `position-absolute ${positionClasses[position]}`, className)
  });
});
