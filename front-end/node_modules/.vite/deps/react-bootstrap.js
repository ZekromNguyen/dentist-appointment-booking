...
function getReactVersion() {
  const parts = React72.version.split(".");
  return {
    major: +parts[0],
    minor: +parts[1],
    patch: +parts[2]
...
var Modal2 = React80.forwardRef(({
  ...
  const renderBackdrop = (0, import_react65.useCallback)((backdropProps) => (0, import_jsx_runtime75.jsx)("div", {
    ...backdropProps,
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime75.jsx)("div", {
    ...
    className: (0, import_classnames47.default)(className, bsPrefix, animateStaticModal && `${bsPrefix}-static`),
...
function createButton(name, defaultValue, label = name) {
  function Button3({
    ...
    return (0, import_jsx_runtime95.jsxs)(PageItem, {
      ...props,
...
var Table = React112.forwardRef(({
  ...
  const classes = (0, import_classnames68.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size2 && `${decoratedBsPrefix}-${size2}`, striped && `${decoratedBsPrefix}-striped`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
...
var ToastFade = React114.forwardRef((props, ref) => (0, import_jsx_runtime115.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContainer = React118.forwardRef(({
  ...
  return (0, import_jsx_runtime119.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames71.default)(bsPrefix, position && `position-absolute ${positionClasses[position]}`, className)
  });
});
